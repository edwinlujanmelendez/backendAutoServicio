...
public class PromocionSispas extends GenericBean implements Serializable, Cloneable {
	...
	public PromocionSispas(Long id, String denominacion, String rutas, String servicios, String puntoVenta,
			...
			Integer esAcumulable, Integer esTarifa, String horasPartida, String tipoTarifa, String tiposAsiento,
			Integer grupo_cupones) {
		super();
		this.id = id;
	...
	public Integer getGrupo_cupones() {
		return grupo_cupones;
	}

	public void setGrupo_cupones(Integer grupo_cupones) {
		this.grupo_cupones = grupo_cupones;
	}
